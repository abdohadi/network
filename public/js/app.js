...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['curClass', 'title', 'value', 'newClass', 'newTitle', 'newValue'],
  computed: {
    isChanged: function isChanged() {
      return this.$parent.isChanged;
    },
    mutableClass: function mutableClass() {
      return this.isChanged ? this.newClass : this.curClass;
    },
    mutableTitle: function mutableTitle() {
      return this.isChanged ? this.newTitle : this.title;
    },
...
var render = function() {
  ...
  return _c(
    "button",
    {
      class: _vm.mutableClass,
      attrs: { title: _vm.mutableTitle },
      domProps: { innerHTML: _vm._s(_vm.mutableValue) }
    },
    [_vm._t("default")],
    2
  )
...
Vue.component('form-component', _components_FormComponent_vue__WEBPACK_IMPORTED_MODULE_2__["default"]); // Button component
...
$(document).ready(function () {
  ...
  $('.profile-pic-parent-overlay').hover(function () {
    ...
    $(this).find('.profile-pic-overlay .fa-camera').animate({
      fontSize: '2rem'
    }, 100, function () {
      $(this).animate({
        fontSize: '1.5rem'
  ...
  $('.cancel-profile-pic-btn').on('click', function (e) {
    ...
    $('.profile-picture').attr('src', $(this).data('pic-src')); // Hide profile-form-pic-overlay
          ...
          case 0:
            ...
            return $.ajax({
              ...
              error: function error(_error2) {
                ...
                textarea.siblings('.post-error').html(_error2.responseJSON.errors.body[0]);
              }
            });
          ...
          case 0:
            ...
            return $.ajax({
              ...
              error: function error(_error3) {
                form.find('.comment-error').toggleClass('hidden').html(_error3.responseJSON.errors.body[0]);
